...
The pipeline `object_tracking_npu` in DL Streamer Pipeline Server's [config.json](https://github.com/open-edge-platform/edge-ai-libraries/blob/release-2026.1.0/microservices/dlstreamer-pipeline-server/configs/sample_npu_decode_and_inference/config.json)
