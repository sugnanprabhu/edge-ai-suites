...
- RealSense™ [D400 Family](https://www.realsenseai.com/stereo-depth-cameras/) cameras
...
- Universal Robots UR5e cobot ([ROS 2 Control](https://control.ros.org/master/index.html) driver)
...
- Every manipulator with existing ROS2 drivers with [MoveIt 2](https://moveit.picknik.ai/main/index.html) support and urdf (or xacro) robot description
