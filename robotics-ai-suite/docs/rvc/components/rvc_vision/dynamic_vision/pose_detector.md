...
Its role is to acquire the [RVC Vision Messages](../rvc_vision_messages.md) RotateBBList message subscribing from the object detection component
and the [PointCloud2](https://docs.ros2.org/foxy/api/sensor_msgs/msg/PointCloud2.html) message from Intel® RealSense™ camera node
...
For further information, refer to [SampleConsensusPrerejective](https://pointclouds.org/documentation/classpcl_1_1_sample_consensus_prerejective.html).
For a sample explanation, refers to [PCL Alignment Prerejective](https://pcl.readthedocs.io/projects/tutorials/en/latest/alignment_prerejective.html)
