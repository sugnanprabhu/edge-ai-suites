...
As a rule of thumb, we suggest using [sensor data](https://docs.ros.org/en/rolling/Concepts/Intermediate/About-Quality-of-Service-Settings.html) as the Quality of Service when creating subscriptions and/or publishers.
