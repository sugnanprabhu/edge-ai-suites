...
Here, we adopted and modified the open-source Mujoco Plugin project [MujocoRosUtils](https://github.com/isri-aist/MujocoRosUtils/tree/main) to visualize and simulate the ACT cube transmitting task in Mujoco 2.3.7. Installation is as follows:
...
2. Open new terminal and run OCS2:
   ...
   ![MPC OCS2 node output](assets/images/mpc-ocs2-node-output.png)

   ![MPC Mujoco initialization](assets/images/mpc-mujoco-initialization.png)
