...
- **Data Ingestion - Telegraf**
    ...
    In the above configuration file, the two `[[outputs.influxdb]]` plugins publish the
...
- **Data Processing - Time Series Analytics Microservice**
    ...
    More details at [how-to-configure-custom-udf](./configure-custom-udf.md)
...
2. For helm deployment, follow the [How to deploy with helm](../get-started/deploy-with-helm.md)
